...
```{r}
# Compare the AIC of Possion and negative binomial models and gamma models
AIC<-AIC(possion_model, nb_model, gamma_model)
AIC

#Compare Possion with negative binomial models
lmtest::lrtest(possion_model, nb_model)

# Coefficient to explain negative binomial regression (incidence ratio IRR)
exp(coef(nb_model))

#check Overdispersion
cat("Overdispersion =", possion_model$deviance / possion_model$df.residual)
